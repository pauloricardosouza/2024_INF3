...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Nov-2024 às 21:49
...
(4, 'img/amiibo.webp', 'Amiibo Luigi', 'Amiibo Original Nintendo - Luigi - Super Smash Bros', 'eletronicos', '400.00', 'Novo', '2024-08-08', '20:03:00', 'disponivel');
...
INSERT INTO `usuarios` (`idUsuario`, `fotoUsuario`, `nomeUsuario`, `cidadeUsuario`, `telefoneUsuario`, `emailUsuario`, `senhaUsuario`, `tipoUsuario`, `statusUsuario`) VALUES
(1, 'img/senhorCapivara.jpeg', 'Capivara Roedora de Matos', 'telemaco', '(42) 99999-9999', 'capivara@gmail.com', '202cb962ac59075b964b07152d234b70', 'admin', 'ativo'),
(2, 'img/peco.jpeg', 'Paulo Ricardo de Souza Silva', 'telemaco', '(42) 99999-9999', 'paulo.silva@ifpr.edu.br', '202cb962ac59075b964b07152d234b70', 'cliente', 'ativo');
